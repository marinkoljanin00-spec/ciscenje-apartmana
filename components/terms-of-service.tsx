        ...
        <Card className="border-border/50">
          ...
          <CardContent className="space-y-6 text-sm leading-relaxed">
            ...
            <section className="space-y-2">
              ...
              <p>
                Korištenjem platforme CLEANUP ("Platforma") pristajete na sve uvjete i odredbe ovdje navedene. Ako se ne slažete s bilo kojom od navedenih odredbi, molimo vas da ne koristite Platformu. Vaš neprekidni pristup Platformi predstavlja vašu prihvaćenost svih ažuriranja uvjeta.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                CLEANUP je online platforma koja povezuje vlasnike stambenih ili poslovnih prostora ("Vlasnici") s osobama koje pružaju usluge čišćenja ("Čistači"). Platforma olakšava komunikaciju, dogovor i obračun usluga između korisnika. Platforma nije zaposlenik niti pružateljem usluga čišćenja - ona je samo intermedijar.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                ...
                <li>CLEANUP nije odgovoran za neovlašteni pristup vašem računu</li>
                <li>Morate odmah obavijestiti CLEANUP o neovlaštenom korištenju računa</li>
              </ul>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Sav sadržaj na Platformi, uključujući logo, dizajn, kod i tekst, jest vlasništvo CLEANUP ili njenih licencijatora. Zabranjeno je kopirati, reproducirati ili distribuirati sadržaj bez pisane dozvole.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>CLEANUP je samo intermedijar i nije odgovorna za kvalitetu usluga</li>
                <li>Vlasnici i Čistači su odgovorna za svoje interakcije i dogovore</li>
                <li>CLEANUP preporučuje potpisivanje pisanih sporazuma prije početka posla</li>
                <li>Sporovi između korisnika trebali bi biti razriješeni bez sudjelovanja CLEANUP</li>
              </ul>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                CLEANUP nije odgovorna za: (a) indirektne, slučajne ili posljedične štete; (b) gubitke podataka; (c) prekid rada Platforme; (d) štete nastale korištenjem Platforme. CLEANUP ne daje nikakva jamstva vezana uz točnost, pouzdanost ili dostupnost Platforme.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                CLEANUP zadržava pravo naplaćivanja administrativne provizije od 10% na sve obavljene poslove. Sve cijene su iskazane u eurima (EUR). CLEANUP nije odgovorna za porezne obveze korisnika - one su isključivo odgovornost korisnika.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Preporučujemo da korisnici provode razumnu provjeru prije angažiranja čistačkog servisa. CLEANUP preporučuje potpisivanje ugovora o osiguranju i provođenje provjere背景ung za sve čistače prije dozvoljavanje pristupa vašem prostoru.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                CLEANUP zadržava pravo suspenzije ili brisanja računa bez najave ako korisnik krši ove uvjete. Korisnici mogu zatražiti povraćaj podataka u roku od 30 dana od brisanja računa.
              </p>
            </section>
            ...
            <section className="space-y-2">
              ...
              <p>
                Za pitanja ili prigovore vezane uz ove uvjete, kontaktirajte nas na: <span className="font-semibold">admin@cleanup.hr</span>
              </p>
            </section>
          </CardContent>
        </Card>
