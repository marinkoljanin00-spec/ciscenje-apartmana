...
export type Job = { id: number; title: string; location: string; price: number; status: string; created_at: string; property_type?: string; is_urgent?: boolean; description?: string; cleaner_id?: number; cleaner_name?: string; cleaner_email?: string; cleaner_phone?: string; application_count?: number; city?: string; client_name?: string; client_rating?: number }
