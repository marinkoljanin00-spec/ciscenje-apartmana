...
export type Job = { id: number; title: string; location: string; price: number; status: string; created_at: string; property_type?: string; is_urgent?: boolean; description?: string; cleaner_id?: number; cleaner_name?: string; cleaner_email?: string; cleaner_phone?: string; application_count?: number; city?: string; client_name?: string; client_rating?: number; client_image_verified?: boolean }
export type Application = { id: number; job_id: number; cleaner_id: number; client_id?: number; status: string; message?: string; created_at: string; cleaner_name?: string; rating?: number; phone?: string; email?: string; title?: string; location?: string; price?: number; job_status?: string; is_urgent?: boolean; client_name?: string; client_email?: string; client_phone?: string; image_verified?: boolean }
